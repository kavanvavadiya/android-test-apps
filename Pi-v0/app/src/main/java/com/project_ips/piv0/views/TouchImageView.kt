...
defStyle   The default style to apply to this view. If 0, no style will be applied (beyond what is included in the theme).
...
open class TouchImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
    ...
    protected var touchMatrix: Matrix by Delegates.observable(Matrix()) { _, oldValue,
                                                                          newValue ->
//        val floatArray : FloatArray = floatArrayOf()
//        oldValue.getValues(floatArray)
//        Log.d(tag,"Old Value $floatArray")
//        newValue.getValues(floatArray)
//        Log.d(tag,"New Value $floatArray")
        Log.d(tag, "DelegatesWork")
    }
